...
📜 **INFO** : <code><b>{movie_info['plot']}</b></code>"""
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            try:
                ...
                await query.answer("Old Link Expired 🔥 Please Search Again.",show_alert=True)
                return
            ...
            buttons = [[
                InlineKeyboardButton('💠 𝗝𝗼𝗶𝗻 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 💠', url='https://t.me/Minnal_Murali2021HD'),
